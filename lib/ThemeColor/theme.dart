...
class ThemeColor {
  ...
  static const card_color = Color(0xFFD9D9D9); //Dashboard Card Color
  static const TextFieldColor = Color(0xFFFFFFFF); //TextField Inside Color
  static const EmployeeText = Colors.grey;
}
