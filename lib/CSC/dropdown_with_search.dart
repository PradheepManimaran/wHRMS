      ...
      child: GestureDetector(
        onTap: () async {
          ...
          if (selectedValue != null) {
            ...
            // Set a default value when the dialog is dismissed or a null value is returned
            final defaultValue = items.isNotEmpty ? items.first : null;
          ...
          child: Row(
            children: [
              Icon(Icons.location_pin,
                  color: Colors.black.withOpacity(0.7)), // Prefix Icon
              Expanded(
