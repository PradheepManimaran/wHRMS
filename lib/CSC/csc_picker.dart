...
import 'package:wHRMS/CSC/dropdown_with_search.dart';
import 'package:wHRMS/CSC/models/select_status_model.dart';
...
class CSCPickerState extends State<CSCPicker> {
  ...
  Future<dynamic> getResponse() async {
    var res = await rootBundle.loadString('lib/CSC/assets/country.json');
